...
<body>
    <div class="container">
        ...
        <div style="background: #000000; border: 2px solid #333333; padding: 20px; border-radius: 15px; margin-bottom: 30px;">
            <strong style="color: #ffffff;">🔮 Welcome back, {{ session.username }}!</strong>
            <a href="{{ url_for('logout') }}" class="btn" style="margin-left: 20px;">🚪 Logout</a>
        </div>
        {% endif %}
